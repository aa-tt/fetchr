...
class BarcoderRaiseIssueAdapter (private val onItemCheckListener: BottomSheetIssueTypeFragment, private val context: Context, private val items: List<String>, private val isBin: Boolean) : RecyclerView.Adapter<BarcoderRaiseIssueAdapter.ViewHolder>() {
